...
function pushCombine (): PushProducer<[]>
function pushCombine <T1>(p1: PushProducer<T1>): PushProducer<[T1]>
function pushCombine <T1, T2>(p1: PushProducer<T1>, p2: PushProducer<T2>): PushProducer<[T1, T2]>
function pushCombine <T1, T2, T3>(p1: PushProducer<T1>, p2: PushProducer<T2>, p3: PushProducer<T3>): PushProducer<[T1, T2, T3]>
function pushCombine <T1, T2, T3, T4>(p1: PushProducer<T1>, p2: PushProducer<T2>, p3: PushProducer<T3>, p4: PushProducer<T4>): PushProducer<[T1, T2, T3, T4]>

function pushCombine (...producers: PushProducer<any>[]): PushProducer<any> {
